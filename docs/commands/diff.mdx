...
`linguist-generated`, `linguist-vendored`, or `binary` Git attributes in the requested head
revision are skipped by default. Use `--ignore-git-attributes=false` to include them.
