...
(`history.hotspot` = cognitive complexity × commit frequency — is this a
fragile, frequently-touched file?), and **Churn** (`history.churn.relative` —
...
compared revision. All columns are review-prioritization signals, not quality
