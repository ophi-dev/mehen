...
`.gitattributes`, `.git/info/attributes`, and configured global attributes. Files with any of these
attributes set, or assigned the value `true`, are excluded before parser dispatch:
