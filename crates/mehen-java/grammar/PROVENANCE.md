...
| Rust runtime + generator | [`ophi-dev/antlr-rust-runtime`](https://github.com/ophi-dev/antlr-rust-runtime) `v0.6.3` |
...
cargo install antlr-rust-runtime --version 0.6.3 --bin antlr4-rust-gen --force
